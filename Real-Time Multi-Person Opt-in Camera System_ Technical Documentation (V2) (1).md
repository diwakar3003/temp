...
| Method | Window Size (s) | Latency (ms) | Similarity Score (Max 1.0) | Fréchet Distance (m) |
| :--- | :--- | :--- | :--- | :--- |
| **Mahalanobis (Chosen)** | 1.0 | 5.2 | 0.89 | 0.18 |
| **Mahalanobis (Chosen)** | 1.5 | 7.8 | 0.91 | 0.15 |
| **Mahalanobis (Chosen)** | 2.0 | 10.4 | **0.92** | **0.14** |
| **Euclidean** | 1.0 | **1.1** | 0.75 | 0.35 |
| **Euclidean** | 1.5 | 1.6 | 0.77 | 0.32 |
| **Euclidean** | 2.0 | 2.1 | 0.78 | 0.30 |
| **DTW** | 1.0 | 45.0 | 0.85 | 0.22 |
| **DTW** | 1.5 | 67.5 | 0.87 | 0.20 |
| **DTW** | 2.0 | 90.0 | 0.88 | 0.19 |
...
*   **Accuracy (Fréchet Distance):** Mahalanobis consistently achieves the lowest Fréchet Distance (best trajectory match) due to its ability to leverage the UKF's covariance matrix, effectively down-weighting noisy observations and up-weighting confident ones.
